...
public:
  ...
  //inline cont::cont_elem* operator->() const {return _ptr;}
  std::vector<cont::cont_elem> operator[](difference_type rhs) const {
    std::vector<cont::cont_elem> tmp;
