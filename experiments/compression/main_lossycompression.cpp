...
run_verbose(const setting_t& setting) {
  ...
  const auto plain_bitmap = dtl::gen_random_bitmap_markov(n, f, d);
...
//  const std::vector<$f64> fprs {0.0, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0};
  ...
  for (auto fpr : fprs) {
    ...
    std::cout << "compression ratio:   "
        << ((compressed_bitmap.size_in_byte() * 1.0) / ((n + 7) / 8))
        << std::endl;
    {
      // Validation code.
...
$i32 main() {
  std::string s("");
  ...
  std::cout << b << std::endl;
  std::cout << dtl::to_bitmap_using_iterator(t) << std::endl;
  if (dtl::to_bitmap_using_iterator(t) != b) {
    std::cout << "VALIDATION FAILED" << std::endl;
  }
}
